 ...
 * @author jara
 */
public class JFOrderInComeOnTime extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFOrderInComeOnTime
     */
    public JFOrderInComeOnTime() {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(30, 30, 650, 360);

        btnExport.setText("Exportar HTML");
        ...
        btnExport.setBounds(240, 400, 190, 27);
    ...
    private void listarOCT() {
        String sql = "SELECT * FROM pedido WHERE pedido_a_tiempo=1 AND en_tienda=0 AND tienda_destino=?";
    ...
    public void generar(DefaultTableModel model) throws IOException {
        ...
        fichero.write("</head>");
        fichero.write("<body>");
        fichero.write("<h2>Listado de pedido que están en tiempo de estar en la tienda pero debe verificarse su ingreso.</h2>");
        ...
        for (int i = 0; i < filas; i++) {
            fichero.write("<tr>");
            int columnas = table2.getColumnCount();
            for (int j = 0; j < columnas; j++) {
                fichero.write("<th>" + table2.getValueAt(i, j) + "</th>");
            }
            fichero.write("</tr>");
        }
        fichero.write("</table>");
